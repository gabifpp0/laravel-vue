...
onMounted(() => {
  ...
  produtos.value.push(
    { id: 1, nome: 'Bolo de Chocolate', preco: 35.00, disponivel: true },
    { id: 2, nome: 'Torta de Limão', preco: 28.50, disponivel: false },
    { id: 3, nome: 'Cupcake', preco: 8.00, disponivel: true }
  )
})
</script>